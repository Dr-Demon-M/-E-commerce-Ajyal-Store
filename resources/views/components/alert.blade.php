...
<div class="px-2 mt-2">
    ...
    @if (session('success'))
        <div class="alert alert-light border-left-success shadow-sm d-flex align-items-center mb-3 py-3" role="alert"
    ...
    @if (session('update'))
        <div class="alert alert-light border-left-info shadow-sm d-flex align-items-center mb-3 py-3" role="alert"
